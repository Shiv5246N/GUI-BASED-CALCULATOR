...
val_reci = Button(frame, text = '1/x', command= lambda: [screen.insert(0,"1/"), simplify()])
val_sqr = Button(frame, text = 'x^2', command= lambda: screen.insert(END, '^2'))
val_root2 = Button(frame, text = 'r2', command= lambda: screen.insert(END, '^(1/2)'))
