...
photo = PhotoImage(file=r"C:\Users\ajayk\OneDrive\Desktop\butterfly-2028591__480 (1).png")
...
style.element_create("but.field", "image", photo,height=10,width=50)


style.layout("TButton", 
                [("Button.button", {"children":
                    [("Button.but.field", {"children":
...
style.configure("Off.TButton", fieldbackground="red",borederwidth=0, relief=FLAT)
...
val_reci = Button(frame, text = '1/x', style="Off.TButton", command= lambda: screen.insert(END, '0'))
...
val_0 = Button(frame, text='0', style="_white.TButton", command= lambda: screen.insert(END, '0'))
