...
photo = PhotoImage(file=r"blue_button.png")
photo2 = PhotoImage(file=r"blue_button2.png")
...
style.element_create("but2.field", "image", photo2,height=10,width=50)

style.layout("TButton", 
                [("Button.button", {"children":
                    [("Button.focus", {"children":
                        [("Button.but.field", {"sticky": NE, "children":
